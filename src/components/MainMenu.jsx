...
import { FaHome, FaPuzzlePiece, FaHeart } from "react-icons/fa";
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8">
      {Object.entries(duration).map(([unit, value]) => (
        <div
          key={unit}
          className="bg-pink-800 bg-opacity-50 p-4 rounded-lg text-center"
        >
                  ...
                  {menuItems.map((item) => (
                    <li key={item.id}>
                      ...
                      >
                        ...
                        {hoverEffect === item.id && (
                          <span className="ml-auto text-pink-300 animate-pulse">
                            ❤️
                          </span>
                        )}
                      </button>
            ...
            <div className="bg-pink-900 bg-opacity-50 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-pink-400 border-opacity-30 min-h-[80vh]">
              {currentPage === "home" && (
                <div className="text-center">
                  <h1 className="text-4xl font-bold text-pink-200 mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="relative group overflow-hidden rounded-xl">
                      <img
                        src={ustogether}
                        alt="Us together"
                        className="w-full max-h-80 object-cover rounded-lg transform group-hover:scale-105 transition-transform duration-500"
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-pink-800 bg-opacity-50 p-4 rounded-xl border border-pink-400 border-opacity-30">
                      ...
                      <ul className="text-pink-300 space-y-2">
                        <li>First Meet: Aug 8, 2023</li>
                        <li>First Date: Oct 12, 2023</li>
                        <li>Anniversary: Dec 30, 2023</li>
                      </ul>
                    </div>
                    <div className="bg-pink-800 bg-opacity-50 p-4 rounded-xl border border-pink-400 border-opacity-30">
                      <h3 className="text-xl font-semibold text-pink-200 mb-2">
                      ...
                      <ul className="text-pink-300 space-y-2">
                        <li>Favorite Cafe: Starbucks</li>
                        <li>Favorite Park: KI</li>
                      </ul>
                    </div>
                    <div className="bg-pink-800 bg-opacity-50 p-4 rounded-xl border border-pink-400 border-opacity-30">
                      <h3 className="text-xl font-semibold text-pink-200 mb-2">
                      ...
                      <ul className="text-pink-300 space-y-2">
                        <li>Trips Together: 5</li>
                        <li>Movies Watched: 52</li>
                        <li>Songs Shared: 89</li>
                      </ul>
                    </div>
                  </div>
                </div>
